...
const createTrip = async () => {
  ...
  try {
    ...
    const tripRes = await fetch(
      `${API_URL}/trips?name=` + encodeURIComponent(tripName.value),
      {
        method: "POST",
      }
    );
  ...
  <div class="max-w-6xl mx-auto px-4 py-8">
    <div class="text-center mb-10">
      <h1 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">
        ...
        <span class="block text-indigo-600 text-lg font-medium mt-2"
          >輕鬆建立與管理您的每一次出遊</span
        >
      </h1>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        >
          ...
          <div class="p-6 space-y-6">
            ...
            <div>
              ...
              <div
                class="flex flex-wrap gap-2 min-h-[3rem] p-3 bg-gray-50 rounded-lg border border-dashed border-gray-300"
              >
      ...
      <div class="lg:col-span-7">
        <div
          class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 h-full"
        >
          <div
          ...
          >
            ...
            <span
              class="bg-gray-200 text-gray-700 py-1 px-3 rounded-full text-xs font-bold"
              >{{ trips.length }} 個旅程</span
            >
          </div>
